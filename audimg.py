...
def get_subject_ds(subject, cache=False, cache_dir='ds_cache'):
    ...
    if not cache or cache_fail:
        ...
        for run in range(1,9):
            ...
            tgts=np.loadtxt(opj('/isi/music/auditoryimagery2/targets', accessions[subject]+'_run-%02d.txt'%r)).astype('int')
...
def collate_model_results(save=False, n_null=1000, t=0.01, tt='tt', **kwargs):
    """
