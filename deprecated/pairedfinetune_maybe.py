...
# bests for genre dataset pretraining
...
if __name__ == "__main__":
    with torch.autograd.set_detect_anomaly(True):
        ...
        if "-dataset" in opts:
            ...
            orig_dataset = "genre"  # arbitrary default value
        ...
        if seq_len==5:
            if orig_dataset=="genre":
                ...
                dataset = "2023-04-12-5TR_audimg_HOruns_hasimagined_4-1-pairs" #stride is 2 or 5, posneg is True or False
        elif seq_len==10:
        ...
        if pretrain_task == "fresh":
            ...
            pretrained_model_states = "/isi/music/auditoryimagery2/seanthesis/thesis/pairedpretrain/trained_models/" # editme
        ...
        hp_dict={
            ...
            "CLS_task":task, # the finetuning task
            "num_CLS_labels": 2,
        ...
        if orig_dataset =="genre":
            ...
            hp_dict["data_path"] = pitchclass_finetune_path + str(hp_dict["CLS_task"])+"/" + hp_dict["data_dir"] + "/"
        ...
        if val_flag!=0:
            for detailed_val_label in val_Y_detailed:
                ...
                if tf == 1:
                    ...
                    print(
                        "label value neither True nor False in detailed val label " + str(
                            detailed_val_label) + ", quitting...")
                    exit(0)
        ...
        #         print(name, param.data)
            ...
            if save_model: # save model is set by command line argument
                modelcount=0
                model_path = "/isi/music/auditoryimagery2/seanthesis/thesis/pairedpretrain/trained_models/"+str(hp_dict["task"])+"/states_"+str(thiscount)+str(modelcount)+".pt"
                while(os.path.exists(model_path)):
                    modelcount+=1
                    model_path = "/isi/music/auditoryimagery2/seanthesis/thesis/pairedpretrain/trained_models/"+str(hp_dict["task"])+"/states_"+str(thiscount)+str(modelcount)+".pt"

                torch.save(model.state_dict(),model_path)
                model_path = "/isi/music/auditoryimagery2/seanthesis/thesis/pairedpretrain/trained_models/"+str(hp_dict["task"])+"/full_" + str(thiscount) + str(
                    modelcount) + ".pt"
