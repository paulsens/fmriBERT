...
if __name__ == "__main__":
    with torch.autograd.set_detect_anomaly(True):
        ...
        if env=="discovery":
            ...
            data_path = "/isi/music/auditoryimagery2/seanthesis/timedir/pretrain/datasets/"+hp_dict["data_dir"]+"/"
        ...
        with open(data_path + "all_X"+hp_dict["fold_str"]+".p", "rb") as samples_fp:
            train_X = pickle.load(samples_fp)
        with open(data_path + "all_y"+hp_dict["fold_str"]+".p", "rb") as labels_fp:
            train_y_detailed = pickle.load(labels_fp)
        with open(data_path + "all_val_X"+hp_dict["fold_str"]+".p", "rb") as valsamples_fp:
            val_X = pickle.load(valsamples_fp)
        with open(data_path + "all_val_y"+hp_dict["fold_str"]+".p", "rb") as vallabels_fp:
        ...
        for detailed_val_label in val_y_detailed:
            this_label = make_timbre_decode_label(detailed_val_label, hp_dict["CLS_task"])
